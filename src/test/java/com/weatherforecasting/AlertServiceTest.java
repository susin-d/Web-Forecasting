...
class AlertServiceTest {
    ...
    void setUp() {
        ...
        CurrentWeather current = new CurrentWeather(30.0, 25.0, 180.0, 1, "2023-10-01T12:00");
    ...
    void testCheckAlertsForUser_TemperatureAlert() {
        CurrentWeather current = new CurrentWeather(40.0, 5.0, 180.0, 1, "2023-10-01T12:00");
        weatherData = new WeatherData(current, Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
